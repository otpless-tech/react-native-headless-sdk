...
both platforms (SDK-GUIDE.md §7). It is adapted from
...
matches what `docs/SDK-GUIDE.md` §7 documents as the verbatim envelope — it guards against the
...
`docs/SDK-GUIDE.md` §7, flag `**BREAKING:**` in `CHANGELOG.md` if applicable, and check
`otpless-rn-lite` (and the native Android/iOS SDKs feeding this bridge) for the same shape. Do
